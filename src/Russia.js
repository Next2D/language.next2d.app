...
class Russia extends Language
{
    ...
    {
        return new Map([
            ["{{Shape変形ツール(A)}}", "Инструмент преобразования формы(A)"],
            ["{{選択ツール(V)}}", "Инструменты выбора(V)"],
            ["{{閉じる}}", "Закрыть"],
            ["{{保存}}", "Сохранить"],
            ["{{リセット}}", "сброс"],
            ["{{スクリーン}}", "Экран"],
            ...
            ["{{サポート}}", "поддержка"],
            ["{{未使用のアイテムを全て削除}}", "Уберите все неиспользуемые предметы"],
            ...
            ["{{読込(画像, MP3, MP4, SWF)}}", "Чтение (изображения, MP3, MP4, SWF)"],
            ["{{新規フォルダー}}", "Новая папка"],
